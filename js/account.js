var username_alloted=['taha','abdulkadir','aliasgar','abbas','shabbir'];
...
function setActive(e){
	...
	if(previousElement.length==1){
		previousElement[0].setAttribute('class','from-control');
	}
	element.setAttribute('class','from-control active');
}
